...
import { classifyCategory, classifyRiskLevel, extractTags } from "./classifier.js";
import { processNewsItemsWithAI } from "./ai-extractor.js";
...
const NEWS_SOURCES = [
    ...
    { url: "https://www.rferl.org/api/zrqoptkm_t", name: "Radio Free Europe/RL", country: "Global" },
    ...
    { url: "https://rss.nytimes.com/services/xml/rss/nyt/MiddleEast.xml", name: "NYT Middle East", country: "Middle East" },
    // ═══════════════════════════════════════════════════════════
    ...
    { url: "https://www.thenews.com.pk/rss/1/16", name: "The News International", country: "Pakistan" },
    { url: "https://tribune.com.pk/feed/rss", name: "Express Tribune Pakistan", country: "Pakistan" },
    { url: "https://www.nation.com.pk/rss", name: "The Nation Pakistan", country: "Pakistan" },
    { url: "https://www.samaa.tv/feed/", name: "Samaa News Pakistan", country: "Pakistan" },
    // ═══════════════════════════════════════════════════════════
    // INDIA  ✓ verified
    // ═══════════════════════════════════════════════════════════
    ...
    { url: "https://www.thehindu.com/news/national/?service=rss", name: "The Hindu", country: "India" },
    ...
    // ═══════════════════════════════════════════════════════════
    // BANGLADESH / SRI LANKA / NEPAL / AFGHANISTAN  ✓ verified
    // ═══════════════════════════════════════════════════════════
    ...
    { url: "https://bianet.org/english/rss", name: "Bianet Turkey (press freedom)", country: "Turkey" },
    // ═══════════════════════════════════════════════════════════
    // UAE / SAUDI ARABIA / GULF  ✓ verified
    // ═══════════════════════════════════════════════════════════
    { url: "https://www.thenationalnews.com/arc/outboundfeeds/rss/?outputType=xml", name: "The National UAE", country: "United Arab Emirates" },
    ...
    { url: "https://english.alarabiya.net/rss.xml", name: "Al Arabiya", country: "Saudi Arabia" },
    // ═══════════════════════════════════════════════════════════
    // ISRAEL & PALESTINE  ✓ verified
    // ═══════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════
    // IRAQ / SYRIA / LEBANON / JORDAN / YEMEN  ✓ verified
    // ═══════════════════════════════════════════════════════════
    { url: "https://www.iraqinews.com/feed/", name: "Iraq News", country: "Iraq" },
    { url: "https://www.syriahr.com/en/feed/", name: "Syrian Observatory for Human Rights", country: "Syria" },
    ...
    { url: "https://www.ghanaweb.com/GhanaHomePage/rss/ghanaweb.xml", name: "GhanaWeb", country: "Ghana" },
    // ETHIOPIA  ✓ verified
    ...
    // UGANDA / TANZANIA / RWANDA  ✓ verified
    ...
    // SOMALIA / SUDAN / SOUTH SUDAN  ✓ verified
    ...
    { url: "https://www.algerie360.com/feed/", name: "Algerie360 Algeria", country: "Algeria" },
    // DRC / CAMEROON / SENEGAL / ZIMBABWE / ZAMBIA  ✓ verified
    ...
    { url: "https://www.bbc.co.uk/news/england/rss.xml", name: "BBC UK", country: "United Kingdom" },
    // ═══════════════════════════════════════════════════════════
    // EUROPE — GERMANY / FRANCE / SPAIN / ITALY  ✓ verified
    // ═══════════════════════════════════════════════════════════
    ...
    // BALKANS / EASTERN EUROPE / CAUCASUS  ✓ verified
    ...
    { url: "https://spring96.org/en/rss", name: "Spring 96 Belarus", country: "Belarus" },
            ...
            try {
                ...
                for (const incident of extracted) {
                    ...
                    await db.insert(incidentsTable).values({
                        ...
                        fullContent: incident.summary, // The AI summary is our primary content now
                        sourceUrl: incident.sourceUrl,
                        sourceName: "AI Aggregated News", // We can parse domains if needed, or stick to this
                        country,
                        latitude: coords[0],
                        longitude: coords[1],
                        category,
